...
import org.junit.runner.RunWith;
    ...
    @CucumberOptions(
            plugin = {"html:target/cucumber-reports2.html", // yanlarina 2 yazdik cunku diger raporlarla karısıyor
                    "json:target/json-reports/cucumber2.json",
                    "junit:target/xml-report/cucumber2.xml"
            },
            features = "src/test/resources/features",
            glue = "stepDefinitions",
            tags = "@pr2",         // "@pr1 and @pr2" yazarsak paralel degil sirali calistirir
            dryRun = false
    )
    ...
    /*
        ...
        @RunWith(Cucumber.class) notasyonu Runner class'ina calisma ozellii katar
       ...
       dyrRun : iki secenek var

            dryRun= true yazdigimizda testimizi calistimadan sadece eksik adimlari bize verir
